...
def plot_pop_new(ddir, x, data_all, ncol):
    ...
    print('plot_pop=',x[1], len(data1), len(data_all))
...
#        print( nc1, nc2,y[nc1],y[nc2], y)
    ...
    print('plot_corr=',x[1],  len(data1), len(data_all))
...
def plot_pop(ddir, x, data_all):
    ...
    print('plot_pop=',x[1], i, len(data1), len(data_all))
...
def plot_corr(ddir, x, data_all):
    ...
    print('plot_corr=',x[1], i, len(data1), len(data_all))
...
def tls_growth(ddir):
    ...
    for i in range(2000, YEAR):
        ntls,nref=0,0
        for x in datatls:
	    if str(i) in x: ntls=ntls+1
        for y in dataref:
            if str(i) in y: nref=nref+1
